...
public class ExportWord2 {
    ...
    public static boolean exportWord(final String resourcePath, String templatePath, String fileName, Map<String, Object> data, HttpServletResponse response) throws IOException {
